# Generated by Django 3.1.7 on 2021-02-27 13:49

from decimal import Decimal
from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import wallets.date_time
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateField(default=wallets.date_time.DateTime.datenow)),
        ...
        migrations.AddField(
            model_name='wallet',
            name='currency',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wallets.walletcurrency'),
        ),
        migrations.AddField(
            model_name='wallet',
            name='user',
